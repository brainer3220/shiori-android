...
Save the PRD as JSON in directory: /Users/brainer/Programming/shiori-android/docs/.agents/tasks
...
User request:
docs/api-reference.md 에 대응하는 android app. url share intent로 `POST /api/links
